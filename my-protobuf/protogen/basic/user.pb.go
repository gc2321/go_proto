...
type Address struct {
	...
	Coordinate *Address_Corrdinate `protobuf:"bytes,16,opt,name=coordinate,proto3" json:"coordinate,omitempty"`
}
...
func (x *Address) GetCoordinate() *Address_Corrdinate {
	if x != nil {
		return x.Coordinate
	}
	return nil
...
type SocialMedia struct {
	...
	SocialMediaPlatform string `protobuf:"bytes,1,opt,name=social_media_platform,json=socail_media_platform,proto3" json:"social_media_platform,omitempty"`
	SocialMediaUsername string `protobuf:"bytes,2,opt,name=social_media_username,json=socail_media_username,proto3" json:"social_media_username,omitempty"`
}
...
type Address_Corrdinate struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Address_Corrdinate) Reset() {
	*x = Address_Corrdinate{}
	mi := &file_proto_basic_user_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Address_Corrdinate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Address_Corrdinate) ProtoMessage() {}

func (x *Address_Corrdinate) ProtoReflect() protoreflect.Message {
	mi := &file_proto_basic_user_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Address_Corrdinate.ProtoReflect.Descriptor instead.
func (*Address_Corrdinate) Descriptor() ([]byte, []int) {
	return file_proto_basic_user_proto_rawDescGZIP(), []int{1, 0}
}

func (x *Address_Corrdinate) GetLatitude() float64 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *Address_Corrdinate) GetLongitude() float64 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
var file_proto_basic_user_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x13, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2e, 0x43, 0x6f, 0x72, 0x72,
	0x64, 0x69, 0x6e, 0x61, 0x74, 0x65, 0x52, 0x0a, 0x63, 0x6f, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x61,
	0x74, 0x65, 0x1a, 0x46, 0x0a, 0x0a, 0x43, 0x6f, 0x72, 0x72, 0x64, 0x69, 0x6e, 0x61, 0x74, 0x65,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x73, 0x6f, 0x63, 0x61, 0x69, 0x6c, 0x5f, 0x6d, 0x65,
	...
	0x61, 0x69, 0x6c, 0x5f, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61,
...
var file_proto_basic_user_proto_goTypes = []any{
	...
	(*Address_Corrdinate)(nil), // 6: Address.Corrdinate
...
var file_proto_basic_user_proto_depIdxs = []int32{
	...
	6, // 3: Address.coordinate:type_name -> Address.Corrdinate
